...
<div class="container">
	...
	<div class="head-t">
		...
		<ul class="megamenu skyblue">
			...
			<li ><a class="color4" href="dish.php">Diswashes,sinks & tabs</a></li>
				<li ><a class="color6" href="fr.php">Fridges & freezes</a>
				
				</li>				
			
				<li class= ><a class="color7" href="ovens.php">Ovens and cooking</a>
				
				</li>				
			
				<li class="active grid"><a class="color4" href="tv">Tv audio & electronics</a>
...
if ($result = mysqli_query($mysqli, $query)) {
 ...
 '; }
	...
	$rez="SELECT *  FROM photos WHERE photos.category=4";
